...
if(!isMobile) {
  ...
  temp = document.getElementById("navbar");
  temp.id ="mobile_navbar";
  temp = document.getElementsByTagName("body")[0];
  temp.style.width="100%";
  // $('#navbar').addClass('navbar-mobile');
  // document.getElementById("#navbar").setAttribute("id", "navbar-mobile");
  // $('#navbar').removeClass('navbar');
  // document.getElementById('menu_button').style.display = "inline-block";
  // document.getElementById('logo').src ="./img/logo.png";
